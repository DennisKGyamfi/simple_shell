...
/**
* sum_node - adds a node to the start of the list
...
list_t *sum_node(list_t **head, const char *str, int num)
{
list_t *new_head;
...
/**
 * sum_node_end - adds a node to the end of the list
 * @head: address of pointer to head node
 * @str: str field of node
 * @num: node index used by history
 *
...
list_t *sum_node_end(list_t **head, const char *str, int num)
{
